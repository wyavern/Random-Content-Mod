...
namespace RandomContentModIII.Common.Systems
{
	...
	{
		public static bool downedWormBoss = false;
		// public static bool downedOtherBoss = false;

		public override void OnWorldLoad()
		{
			downedWormBoss = false;
		...
		{
			downedWormBoss = tag.ContainsKey("downedWormBoss");
