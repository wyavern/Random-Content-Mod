...
namespace RandomContentModIII.Common.UI.ExampleResourceUI
{
	internal class SoulflowBar : UIState
	{
		...
		public override void OnInitialize() {
			...
			barFrame = new UIImage(ModContent.Request<Texture2D>("RandomContentModIII/Common/UI/SoulflowBarFrame")); // Frame of our resource bar
			...
			gradientA = new Color(84, 213, 222); // A dark purple
			gradientB = new Color(165, 47, 204); // A light purple
		...
		protected override void DrawSelf(SpriteBatch spriteBatch) {
			...
			// Calculate quotient
			float quotient = (float)modPlayer.SoulflowCurrent / modPlayer.SoulflowMax2; // Creating a quotient that represents the difference of your currentResource vs your maximumResource, resulting in a float of 0-1f.
		...
		public override void Update(GameTime gameTime) {
			//if (Main.LocalPlayer.HeldItem.ModItem is not WaterWaveBook)
			//	return;
