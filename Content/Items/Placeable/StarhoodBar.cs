...
namespace RandomContentModIII.Content.Items.Placeable
{
	public class StarhoodBar : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.createTile = ModContent.TileType<Tiles.StarhoodBarBlock>(); // The ID of the wall that this item should place when used. ModContent.TileType<T>() method returns an integer ID of the wall provided to it through its generic type argument (the type in angle brackets)..
			Item.placeStyle = 0;
			Item.material = true;
		}
