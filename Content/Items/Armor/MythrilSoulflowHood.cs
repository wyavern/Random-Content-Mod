...
namespace RandomContentModIII.Content.Items.Armor
{
	...
	public class MythrilSoulflowHood : ModItem
	{
		...
		{
			Item.CloneDefaults(ItemID.MythrilHood);
		...
		public override void UpdateArmorSet(Player player) {
			player.setBonus = "increases maximum soulflow by 250 and slightly increases soulflow regeneration and damage.";  // This is the setbonus tooltip
