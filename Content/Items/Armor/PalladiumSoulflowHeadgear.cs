...
namespace RandomContentModIII.Content.Items.Armor
{
	...
	public class PalladiumSoulflowHeadgear : ModItem
	{
		...
		{
			Item.CloneDefaults(ItemID.PalladiumMask);
		...
		public override void UpdateArmorSet(Player player) {
			player.setBonus = "increases maximum soulflow by 150 and drastically increases soulflow regeneration.\nGreatly increases life regeneration after striking an enemy";  // This is the setbonus tooltip
			var modPlayer = player.GetModPlayer<SoulflowPlayer>(); 
			modPlayer.SoulflowRegenRate *= 7.5f;
