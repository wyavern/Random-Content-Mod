...
namespace RandomContentModIII.Content.Items.Armor
{
	...
	public class CorruptRawSoulflowBreastplate : ModItem
	{
		public override void SetStaticDefaults() {
			base.SetStaticDefaults();
			DisplayName.SetDefault("Corrupt Raw Soulflow Breastplate");
			Tooltip.SetDefault("The corrupt soulflow armor."
				+ "\nImmunity to 'On Fire!'"
				+ "\n+10 max soulflow and slightly increased soulflow damage."
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient<CorruptRawSoulflow>(20)
