...
{
	public class SoulflowPickaxe : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Weird how this pickaxe is able to mine pretty much everything"
			+ "\nSeems like soulflow is more durable than it looks."
		...
		public override void SetDefaults() {
			...
			Item.autoReuse = true;
			Item.useTurn = true;
			Item.pick = 209; // How strong the pickaxe is, see https://terraria.gamepedia.com/Pickaxe_power for a list of common values
		}
