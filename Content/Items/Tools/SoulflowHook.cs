...
{
	internal class SoulflowHookItem : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Soulflow Hook"); // The item's name in-game.
		...
		public override void SetDefaults() {
			...
			Item.shootSpeed = 20f; // This defines how quickly the hook is shot.
			Item.shoot = ModContent.ProjectileType<SoulflowHookProjectile>(); // Makes the item shoot the hook's projectile when used.
		}
	...
	internal class SoulflowHookProjectile : ModProjectile
	{
		...
		public override void Load() { // This is called once on mod (re)load when this piece of content is being loaded.
			...
			chainTexture = ModContent.Request<Texture2D>("RandomContentModIII/Content/Items/Tools/SoulflowHookChain");
		}
