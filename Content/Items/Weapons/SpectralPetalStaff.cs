...
{
	public class SpectralPetalStaff : ModItem
	{
		private int SoulflowCost; // Add our custom resource cost

		public override void SetStaticDefaults() {
			CreativeItemSacrificesCatalog.Instance.SacrificeCountNeededByItemId[Type] = 1;
			Tooltip.SetDefault("Shoots a strong flower petal which will pierce and kill your enemies.");
		...
		{
			CreateRecipe()
				.AddIngredient<OrichalcumPetalStaff>(50)
