...
namespace RandomContentModIII.Content.DamageClasses
{
	public class SoulflowDamageClass : DamageClass
	{
		...
		public override StatInheritanceData GetModifierInheritance(DamageClass damageClass) {
			...
			if (damageClass == DamageClass.Ranged)
				...
				return new StatInheritanceData(
					damageInheritance: 0.95f,
					critChanceInheritance: -0.75f,
					attackSpeedInheritance: 0.95f,
					armorPenInheritance: 10f,
					knockbackInheritance: 0.15f
				);
		...
		public override void SetDefaultStats(Player player) {
			...
			player.GetCritChance<SoulflowDamageClass>() += 4;
			player.GetArmorPenetration<SoulflowDamageClass>() += 5;
