...
namespace RandomContentModIII.Content.Buffs
{
	...
	public class PlasmafluxBuff : ModBuff
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Plasma Infusion"); // Buff display name
			Description.SetDefault("Sets your life regen to 25. Nullifies all other life regen buffs. Also increases your defense by 10"); // Buff description
		...
		{
			player.GetModPlayer<PlasmafluxBuffPlayer>().lifeRegenDebuff = true;
			player.statDefense += 10;
		}
	}

	public class PlasmafluxBuffPlayer : ModPlayer
	{
